...
document.addEventListener('DOMContentLoaded', function () {
    var lines = null; // The final result of the search go here
    var contextLines = null; // Context lines for the search go here
    ...
    //Clear out the results list to add new results
    ...
    function populateCharacterOptions() {
        ...
        for (var i = 0; i < charactersLoaded && i < characterName.length; i++) {
            var character = characterNames[i];
        ...
        if (charactersLoaded < characterNames.length) {
    ...
    populateCharacterOptions(); //TODO: Check on JavaScript for this
    ...
    document.getElementById('searchButton').addEventListener('click', function() {
        let lines = submitForm(initialText, initialOption);
    });
